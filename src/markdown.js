/**
 * Markdown渲染模块 - 处理Markdown文本转HTML
 */

import CONFIG from './config.js';
import { escapeHtml, createHtml } from './utils.js';
    ...
    const processMediaEmbed = (regex, createEmbedHTML) => {
      ...
      html = html.replace(new RegExp(regex.source, 'g'), (match, ...args) => {
        ...
        try {
          ...
          return createHtml`<div class="${containerClass}">
            <iframe src="${embedSrc}" 
